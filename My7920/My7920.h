...
//#define SCLKpin		14
//#define MOSIpin		12 // esp32

#define SCLKpin		4// PB10
#define MOSIpin		5// PB11 // stm32
...
void My7920HLine(uint8_t y, uint8_t pattern); // Линия на всю строку
...
void My7920Text(const uint8_t * str, uint8_t start_string); // str - "str1\nstr2\nstr3\n"


uint8_t * get_1024_ptr(void); // Вернуть указатель на буфер экрана
